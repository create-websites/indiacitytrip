<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Chhattisgarh.ascx.cs" Inherits="Chhattisgarh" %>
<div id="sidebar">
...
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/chhattisgarh/" target="_blank">
   <img src="https://www.indiacitytrip.com/logo/chhattisgarh-trip.jpg" alt="Chatttisgarh Trip" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/chhattisgarh/" target="_blank">
   <span class="title">Chattisgarh</span>
  </a>
  <span class="postinfo"></span>
 </span>
</li>           
<li class="clearfix">
  ...
  <span class="postinfo">Howrah Bridge</span>
 </span>
</li>           
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/" target="_blank">
   <img src="https://www.indiacitytrip.com/logo/india-trip.jpg" alt="India Attractions" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/" target="_blank">
   <span class="title">India Attractions</span>
  </a>
  <span class="postinfo">Monuments, Forts, History, wild life</span>
 </span>
</li>        </ul>
  </div> <!-- end .widget -->
 </div> <!-- end #all-tabs -->
