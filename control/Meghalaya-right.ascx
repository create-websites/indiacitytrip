<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Meghalaya-right.ascx.cs" Inherits="Meghalaya_right" %>
...
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/meghalaya/" target="_blank">
...
<div id="recent-posts-7" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Wildlife in Meghalaya</span></h4><div class="widgetcontent">		<ul>			
				</ul>
		</div>
	</div>

		<div id="recent-posts-6" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Festivals in Meghalaya</span></h4><div class="widgetcontent">		<ul>
