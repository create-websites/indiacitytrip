<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Nagaland-right.ascx.cs" Inherits="Nagaland_right" %>
...
<li class="clearfix">
			<a href="#">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/timthumb.png" alt="" width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
...
<li class="clearfix">
			<a href="#">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/timthumb.jpg" alt="" width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
			<span class="title"></span>
		</a>
...
<li class="clearfix">
			<a href="#">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/timthumb_003.jpg" alt="" width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
			<span class="title"></span>
		</a>
...
<li class="clearfix">
			<a href="#">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/timthumb_005.jpg" alt="" width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
			<span class="title"></span>
		</a>
...
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/nagaland/" target="_blank">
   <img src="" alt="Nagaland" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/nagaland/" target="_blank">
   <span class="title">Nagaland</span>
  </a>
  <span class="postinfo"></span>
 </span>
</li>           
...
<div id="recent-posts-7" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Wildlife in Nagaland</span></h4><div class="widgetcontent">		<ul>
		...
		<div id="recent-posts-6" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Festivals in Nagaland</span></h4><div class="widgetcontent">		<ul>
