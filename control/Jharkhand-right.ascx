<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Jharkhand-right.ascx.cs" Inherits="Jharkhand_right" %>
...
<li class="clearfix">
			<a href="Jharkhand-Destinations/Ranchi.aspx">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/Jharkhand/ranchi.jpg" alt="Ranchi, Ranchi Tourism" title="Ranchi Tour"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="Jharkhand-Destinations/Ranchi.aspx">
			<span class="title">Ranchi Tour</span>
		</a>
		<span class="postinfo">Manchester of East Ranchi is an important city and is the capital of young Jharkhand.</span>
	</span>
</li>											
<li class="clearfix">
			<a href="#">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/Jharkhand/Parasnath-temple.jpg" alt="Parasnath Tour" title="Parasnath Tour"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
			<span class="title">Parasnath Tour</span>
		</a>
...
<li class="clearfix">
			<a href="#">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/Jharkhand/Netarhat.jpg" alt="Netarhat Tour" title="Netarhat Tour"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
			<span class="title">Netarhat Tour</span>
		</a>
		<span class="postinfo"></span>
	</span>
</li>								</ul>
...
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/jharkhand/" target="_blank">
   <img src="" alt="jharkhand" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/jharkhand/" target="_blank">
...
<div id="recent-posts-7" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Wildlife in Jharkhand</span></h4><div class="widgetcontent">		<ul>
<li><a href="" title="Dalma Wild Life Sanctuary">Dalma Wild Life Sanctuary</a></li>				
<li><a href="" title="Hazaribagh Wild Life Sanctuary">Hazaribagh Wild Life Sanctuary</a></li>				
<li><a href="" title="Betla National Park">Betla National Park</a></li>				
<li><a href="" title="Palamau Tiger Reserve">Palamau Tiger Reserve</a></li>				
		...
		<div id="recent-posts-6" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Festivals in Jharkhand</span></h4><div class="widgetcontent">		<ul>
<li><a href="" title="Basant Panchami ">Basant Panchami </a></li>				
<li><a href="" title="Chhath Puja">Chhath Puja</a></li>				
<li><a href="" title="Jityya Bhaiya Dooj">Jityya Bhaiya Dooj</a></li>				
<li><a href="" title="Eid-ul-Fitr">Eid-ul-Fitr</a></li>				
<li><a href="" title="Muharrum">Muharrum</a></li>				
<li><a href="" title="Karma">Karma</a></li>				
    ...
    <li><a href="Jharkhand-Destinations/Ranchi.aspx" title="Ranchi Tour">Ranchi Tour</a></li>
<li><a href="" title="Parasnath Tour">Parasnath Tour</a></li>    
<li><a href="" title="Netarhat Tour">Netarhat Tour</a></li>
    	</ul>
</div><!-- end .widget-content --></div> <!-- end .widget -->	
