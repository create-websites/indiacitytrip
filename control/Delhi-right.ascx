<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Delhi-right.ascx.cs" Inherits="Delhi_right" %>
...
<li class="clearfix">
   <a href="Delhi-Destinations/Greater-Noida.aspx">
  ...
  <span class="right">
  <a href="Delhi-Destinations/Greater-Noida.aspx">
   <span class="title">Noida Tour</span>
  </a>
  <span class="postinfo">Greater Noida is an urban settlement and commercial area</span>
 </span>
</li>                              
...
<li class="clearfix">
   ...
   <img src="https://www.indiacitytrip.com/logo/delhi-trip.jpg" alt="Delhi Trip" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/delhi/" target="_blank">
...
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/delhi/connaught-place/" target="_blank">
   <img src="https://www.indiacitytrip.com/logo/connaught-place-trip.jpg" alt="Connaught Place Trip" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/delhi/connaught-place/" target="_blank">
   <span class="title"> Connaught Place</span>
  </a>
  <span class="postinfo">Center of Delhi. Best Shopping destination</span>
 </span>
</li>           
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/delhi/chandni-chowk/" target="_blank">
   <img src="https://www.indiacitytrip.com/logo/chandni-chowk-trip.jpg" alt="Chandni chowk Delhi" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/delhi/chandni-chowk/" target="_blank">
   <span class="title">Chandni chowk</span>
  </a>
  <span class="postinfo">Old Delhi</span>
 </span>
</li>        </ul>
...
<li><a href="" title="Qutub Festival">Qutub Festival</a> </li>    
 ...
 <li><a href="Delhi-Destinations/Greater-Noida.aspx" title="Greater Noida Tour">Greater Noida Tour</a></li>
<li><a href="Delhi-Destinations/Places-to-visit-in-Mehrauli.aspx" title="Places to visit in Mehrauli">Places to visit in Mehrauli</a></li>
