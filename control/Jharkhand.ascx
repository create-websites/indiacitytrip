<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Jharkhand.ascx.cs" Inherits="Jharkhand" %>
...
<li class="clearfix">
			<a href="#">
			<img src="https://storage.googleapis.com/createweb/indiacitytrip.com/code/images/Jharkhand/Parasnath-temple.jpg" alt="Parasnath Temple Tour" title="Parasnath Tour"  width="74" height="74"/>		</a>
		<span class="right">
		<a href="#">
...
<li><a href="" title="Karma">Karma</a></li>				
    ...
    <li><a href="Ranchi.aspx" title="Ranchi Tour">Ranchi Tour</a></li>
