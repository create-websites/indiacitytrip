<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Mizoram-right.ascx.cs" Inherits="Mizoram_right" %>
...
<li class="clearfix">
   <a href="https://gallery.indiacitytrip.com/mizoram/" target="_blank">
   <img src="" alt="Mizoram" width="74" height="74"/>  </a>
  <span class="right">
  <a href="https://gallery.indiacitytrip.com/mizoram/" target="_blank">
   <span class="title">Mizoram</span>
  </a>
  <span class="postinfo"></span>
 </span>
</li>           
...
<div id="recent-posts-7" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Wildlife in Mizoram</span></h4><div class="widgetcontent">		<ul>
		...
		<div id="recent-posts-6" class="widget widget_recent_entries">
        		<h4 class="widgettitle"><span>Festivals in Mizoram</span></h4><div class="widgetcontent">		<ul>
