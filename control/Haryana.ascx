<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Haryana.ascx.cs" Inherits="Haryana" %>
<%@ Register Src="~/control/Haryana-right.ascx" TagName="right" TagPrefix="uc1" %>
<%@ Register Src="~/control/list-best.ascx" TagName="bestplaces" TagPrefix="uc1" %>
...
<li class="clearfix">
 ...
 <li><a href="Faridabad.aspx" title="Faridabad" >Faridabad Tour</a> </li>

<li><a href="manesar-tour.aspx" title="Manesar Tour">Manesar Tour</a> </li>	    
<li><a href="panipat.aspx" title="Panipat Tour">Panipat Tour</a> </li> 
<li><a href="rohtak.aspx" title="Rohtak Tour">Rohtak Tour</a> </li>     
<li><a href="places-to-visit-in-bhiwani.aspx" title="Places to visit in Bhiwani">Places to visit in Bhiwani</a> </li>
<li><a href="places-to-see-in-hisar.aspx" title="Places to see in Hisar">Places to see in Hisar</a> </li>
     </ul>
...
<li><a href="../India-States.aspx" title="India States">read more</a></li>
  ...
  <div id="secondcol">
   <div id="linkcat-2" class="widget widget_links">
       <h4 class="widgettitle"><span>Advertisement</span></h4>
